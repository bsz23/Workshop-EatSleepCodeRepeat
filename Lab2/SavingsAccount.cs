...
namespace eu.sig.training.ch04.v1
{
    public class SavingsAccount
    {
        ...
        public Transfer makeTransfer(string counterAccount, Money amount)
        {
            ...
            if (sum % 11 == 0)
            {
                return DoSomeWork(counterAccount, amount);
            }
            else
            {
        ...
        private int CalcSum(string counterAccount)
        {
            int sum = 0;
        ...
        private void Validate(string counterAccount)
        {
        ...
        private Transfer DoSomeWork(string counterAccount, Money amount)
        {
